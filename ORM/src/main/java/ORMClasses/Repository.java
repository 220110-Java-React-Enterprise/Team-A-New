...
public class Repository<O> {
    ...
    //ORMClasses.Repository ORMClasses.Table object that holds information about storing/retrieving data from SQL table
    ...
    public boolean initializeTable() {
        ...
        //Create and populate a ORMClasses.Table object with Columns
        this.table = new Table(tableName);

        //Temporary ORMClasses.Column object to store fieldName and Property before attempting to store into table
        Column column;
...
/*
        ...
        for (Method m : methods) {
            ...
            if (m.isAnnotationPresent(Getter.class)) {
                ...
                for (ORMClasses.Column c : table.getColumns()) {
                    //Add Getter method to ORMClasses.Column if field name found
            ...
            //Check that the field has the Setter annotation
                ...
                for (ORMClasses.Column c : table.getColumns()) {
                    //Add Setter method to ORMClasses.Column if field name found
                    if (fieldHash == c.getFieldHash()) {
                        c.setSetter(m);
                    }
                }
...
*/
    ...
    public O create(O o) {
        ...
        //Create SQL string generated by ORMClasses.SQLStringScriptor
