...
public class Column {
    ...
    //Method to convert ORMClasses.Column information to string
    @Override
    public String toString() {
        return "ORMClasses.Column: " + fieldName + ", Class field: " + this.getPropertyString() + ", Getter: " + this.getGetterString() +
