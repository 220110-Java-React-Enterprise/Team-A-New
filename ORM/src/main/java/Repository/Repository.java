...
import ORMConnectionManager.ORMConnectionManager;
...
public class Repository<O> {
    ...
    //Repository.Repository Repository.Table object that holds information about storing/retrieving data from SQL table
    ...
    public boolean initializeTable() {
        ...
        //Create and populate a Repository.Table object with Columns
        this.table = new Table(tableName);

        //Temporary Repository.Column object to store fieldName and Property before attempting to store into table
        Column column;
...
/*
        ...
        for (Method m : methods) {
            ...
            if (m.isAnnotationPresent(Getter.class)) {
                ...
                for (Repository.Column c : table.getColumns()) {
                    //Add Getter method to Repository.Column if field name found
            ...
            //Check that the field has the Setter annotation
                ...
                for (Repository.Column c : table.getColumns()) {
                    //Add Setter method to Repository.Column if field name found
                    if (fieldHash == c.getFieldHash()) {
                        c.setSetter(m);
                    }
                }
...
*/
    ...
    public O create(O o) {
        ...
        //Create SQL string generated by SQL.SQLStringScriptor
