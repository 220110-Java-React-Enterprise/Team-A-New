...
public class Table {
    ...
    //Method to return a Repository.Column object from the columns list with given index
    ...
    //Method to retrieve Repository.Column containing field with primary key annotation
    ...
    public String toString() {
        ...
        StringBuilder tableString = new StringBuilder("Repository.Table \"" + this.getTableName() + "\"");
